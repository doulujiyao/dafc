...
class NLayerDiscriminator(nn.Module):
    ...
    """
    def __init__(self, input_nc=3, ndf=64, n_layers=3, norm_layer=nn.GroupNorm, use_sigmoid=False,
                 getIntermFeat=False):
        ...
        for n in range(1, n_layers):
            ...
            sequence += [[
                ...
                norm_layer(1,nf), nn.LeakyReLU(0.2, True)
            ]]
...
class MultiscaleDiscriminator(nn.Module):
    ...
    Args:
        ...
        getIntermFeat (bool): If True, all intermediate features will be returned else only the final feature
    """
    def __init__(self, input_nc=3, ndf=64, n_layers=3, norm_layer=nn.GroupNorm,
