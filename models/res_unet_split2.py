...
def make_conv_block(in_nc, out_nc, kernel_size=3, stride=1, padding=None, bias=False, padding_type='reflect',
                    norm_layer=nn.GroupNorm, act_layer=nn.ReLU(True), use_dropout=False):
    ...
    if norm_layer is not None:
        conv_block.append(norm_layer(1,out_nc))
...
class DownBlock(nn.Module):
    ...
    Args:
        ...
        act_layer (nn.Module): Type of activation layer
    """
    def __init__(self, in_nc, out_nc, kernel_size=3, padding_type='reflect', norm_layer=nn.GroupNorm,
...
class ResnetBlock(nn.Module):
    ...
    Args:
        ...
        use_dropout (bool): If True, enables dropout with probability 0.5
    """
    def __init__(self, planes, kernel_size=3, expansion=1, padding_type='reflect', norm_layer=nn.GroupNorm,
...
class FlatBlock(nn.Module):
    ...
    Args:
        ...
        act_layer (nn.Module): Type of activation layer
    """
    def __init__(self, planes, kernel_size=3, layers=1, padding_type='reflect', norm_layer=nn.GroupNorm,
                 act_layer=nn.ReLU(True)):
...
class SkipConnectionBlock(nn.Module):
    ...
    def __init__(self, ngf, sub_ngf, down_block=None, submodule=None, up_block=None, flat_block=None, flat_layers=1,
                 padding_type='reflect', norm_layer=nn.GroupNorm, act_layer=nn.ReLU(inplace=True), use_dropout=False):
...
class ResUNetatt(nn.Module):
    ...
    def __init__(self, down_block=DownBlock, up_block=UpBlock, flat_block=FlatBlock, in_nc=3, out_nc=(3,), max_nc=None,
                 ngf=64, flat_layers=(0, 0, 0, 3), norm_layer=nn.GroupNorm, act_layer=nn.ReLU(inplace=True),
                 use_dropout=False):
...
class LocalEnhancer(nn.Module):
    ...
    def __init__(self, ngf, sub_ngf, down_block=DownBlock, up_block=UpBlock, flat_block=FlatBlock, in_nc=3, out_nc=(3,),
                 flat_layers=0, padding_type='reflect', norm_layer=nn.GroupNorm, act_layer=nn.ReLU(inplace=True),
                 use_dropout=False):
...
class MultiScaleResUNet(nn.Module):
    ...
    def __init__(self, down_block=DownBlock, up_block=UpBlock, flat_block=FlatBlock, in_nc=3, out_nc=(3,),
                 max_nc=None, ngf=64, flat_layers=(0, 0, 0, 3), norm_layer=nn.GroupNorm,
